    ...
    if (item.mande < 0) {
        return (
            <>
                ...
                {/* <StyledTableCell align='center' className={classes.color} >{item.dahane}</StyledTableCell> */}
                <StyledTableCell align='center' className={classes.color} >{Math.round(item.tedadSefaresh - item.tedadHavaleShode)}</StyledTableCell>
                <StyledTableCell align='center' className={classes.color}>{item.kardexAnbar12_}</StyledTableCell>
                {/* <StyledTableCell align='center' className={classes.color}>{item.kardexAnbar5}</StyledTableCell> */}
        ...
        return (
            <>
                ...
                {/* <StyledTableCell align='center' >{item.dahane}</StyledTableCell> */}
                <StyledTableCell align='center' >{Math.round(item.tedadSefaresh - item.tedadHavaleShode)}</StyledTableCell>
                <StyledTableCell align='center' >{item.kardexAnbar12_}</StyledTableCell>
                {/* <StyledTableCell align='center' >{item.kardexAnbar5}</StyledTableCell> */}
